...
# Gib das allererste und das letzte Element der Liste auf die Kommandozeile aus. 
# Beim Zugriff auf das letzte Element der Liste gibt es zwei verschiedene Möglichkeiten, zeige beide.
liste = [3, 26, -3, 0.5, "apfel"]
print(liste[0], liste[4])  # Zugriff auf das erste und das letzte Element der Liste mit positivem Index
print(liste[-1]) # Zugriff auf das letzte Element der Liste mit negativem Index
...
# birne
# apfel
for listenwert in range(len(liste)):
    if listenwert % 2 == 1: 
        print(liste[listenwert])  